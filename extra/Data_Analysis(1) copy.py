# -*- coding: utf-8 -*-
# @Author: Dastan Alam
# @Date:   2024-07-01 06:13:05 PM   18:07
# @Last Modified by:   Dastan Alam
# @Last Modified time: 2024-07-01 07:23:21 PM   19:07

# @Email:  HARSHMAHILANG7@GMAIL.COM
# @workspaceFolder:  c:\BACKCOFFER
# @workspaceFolderBasename:  BACKCOFFER
# @file:  c:\BACKCOFFER\20211030 Test Assignment\Data_Analysis(1) copy.py
# @relativeFile:  20211030 Test Assignment\Data_Analysis(1) copy.py
# @relativeFileDirname:  20211030 Test Assignment
# @fileBasename:  Data_Analysis(1) copy.py
# @fileBasenameNoExtension:  Data_Analysis(1) copy
...
def process_urls(input_file, output_file):
    ...
    stopwords_files = [
        '20211030 Test Assignment\\StopWords\\StopWords_Currencies.txt',
        '20211030 Test Assignment\\StopWords\\StopWords_Currencies.txt',
        '20211030 Test Assignment\\StopWords\\StopWords_DatesandNumbers.txt',
        '20211030 Test Assignment\\StopWords\\StopWords_Generic.txt',
        '20211030 Test Assignment\\StopWords\\StopWords_GenericLong.txt',
        '20211030 Test Assignment\\StopWords\\StopWords_Geographic.txt',
        '20211030 Test Assignment\\StopWords\\StopWords_Names.txt'
    ]
    ...
    # Process each URL with tqdm for progress bar
    for index, row in tqdm(input_df.iterrows(), total=len(input_df), desc="Processing URLs"):
        url_id = row['URL_ID']
        url = row['URL']
    ...
    try:
        ...
        with pd.ExcelWriter(output_file, engine='openpyxl') as writer:
            ...
            if 'Output' not in writer.book.sheetnames:
